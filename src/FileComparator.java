...
public class FileComparator {
    ...
    public static void main(String[] args) {
        ...
        String filePath1 = "output.txt"; // Replace with your first file path
        String filePath2 = "test_cases/large/500-500/500-500-output-withRadius500.txt"; // Replace with your second file path
